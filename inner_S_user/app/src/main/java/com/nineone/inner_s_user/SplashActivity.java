...
public class SplashActivity extends AppCompatActivity {//어플에서 제일 처음 띄워지는 Splash화면 각종 권한을 확인합니다.
    ...
    private void background_permissionDialog() {
        ...
        builder.setPositiveButton("설정", (dialog, which) -> backgroundPermission());
    ...
    private void checkPermissions(String[] permissi) {
        int result;
        ...
        if (!permissionList.isEmpty()) {
            Log.e("spetc", "102");
            ActivityCompat.requestPermissions(this, permissionList.toArray(new String[0]), MULTIPLE_PERMISSIONS);
        ...
        handler.postDelayed(() -> new Thread() {
            ...
            public void run() {
               SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
                String mstart_name = sp.getString("ID_name", "inners_aos");
             /*   Intent newIntent;
    ...
    private void permissions_refuse_dialog() {
        ...
        localBuilder.setTitle("권한 설정")
                ...
                .setNegativeButton("취소", (paramAnonymousDialogInterface, paramAnonymousInt) -> showToast_PermissionDeny())
                .show();
    }
