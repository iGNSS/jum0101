...
public class ChartMainList extends AppCompatActivity {//걷기 기록들을 리사이클 뷰로 나타내는곳
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mainchart_list);
        ...
        listAdapter.setOnItemClickListener(new ChartListAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View v, int position) {//리스트를 클릭했을때 이벤트
                ...
                if (extensionFilter(f).size() != 0) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(ChartMainList.this);
