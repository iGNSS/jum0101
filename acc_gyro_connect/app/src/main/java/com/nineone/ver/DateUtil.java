...
public class DateUtil {
    ...
    private static final ThreadLocal<SimpleDateFormat> mFilenameFormater = new ThreadLocal<SimpleDateFormat>() {
        private static final String FILENAME_PATTERN = "yyyy-MM-dd-HH-mm-ss";
        @Override
        protected SimpleDateFormat initialValue() {
    ...
    private static final ThreadLocal<SimpleDateFormat> mFilenameFormater2 = new ThreadLocal<SimpleDateFormat>() {
        private static final String FILENAME_PATTERN = "yyyyMMdd";
        @Override
        protected SimpleDateFormat initialValue() {
            return new SimpleDateFormat(FILENAME_PATTERN, Locale.ENGLISH);
        }
    ...
    private static final ThreadLocal<SimpleDateFormat> mFormater2 = new ThreadLocal<SimpleDateFormat>() {
        private static final String DATE_PATTERN = "ss ";
        @Override
        protected SimpleDateFormat initialValue() {
            return new SimpleDateFormat(DATE_PATTERN, Locale.ENGLISH);
        }
    ...
    /** get "yyyy-MM-dd HH:mm:ss.SSS" String */
    public static String get_ss(long ms) {
        return mFormater2.get().format(new Date(ms));
    }
    /** get "yyyy-MMdd-HH-mm-ss.csv" String */
    public static String get_nowdate(long ms) {
    ...
    /** get "yyyy-MMdd.csv" String */
    public static String get_dayCsvFilename() {
        return mFilenameFormater2.get().format(new Date()) + ".csv";
    }

    public static String get_examDatename() {
        return mFilenameFormater2.get().format(new Date());
    }
